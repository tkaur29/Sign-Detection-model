...
engine = pyttsx3.init()
st.set_page_config(page_title="Tech Titans", page_icon="🧑‍💻", layout="wide")
...
def main():
    ...
    with st.container():
        ...
        st.title("Taking initiative to help the specially abled people !!")
        st.write("Used Mediapipe ,Python ,Tensorflow ,Opencv for project")
        st.write("[Learn More>](#)")
